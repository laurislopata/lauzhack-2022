...
public class c {
  ...
  public static void main(String[] args) throws IOException {
    ...
    if (countKilled != 0) {
      if (increase > 0) ans = -1; else ans =
        Math.max(ans, countKilled * bounty);
    }
  ...
  static class FastScanner {
    ...
    public String next() throws IOException {
      if (st.hasMoreTokens()) return st.nextToken(); else st =
