  ...
  static class TreeList<E> extends AbstractList<E> {
    ...
    static class AVLNode<E> {
      ...
      private AVLNode(
        ...
        final E obj,
        final TreeList.AVLNode<E> rightFollower,
        final TreeList.AVLNode<E> leftFollower
      ) {
      ...
      private AVLNode(
        ...
        final int start,
        final int end,
        final int absolutePositionOfParent,
        final TreeList.AVLNode<E> prev,
        final TreeList.AVLNode<E> next
      ) {
        final int mid = start + (end - start) / 2;
        if (start < mid) {
          left =
            new TreeList.AVLNode<>(iterator, start, mid - 1, mid, prev, this);
        } else {
          leftIsPrevious = true;
          left = prev;
        }
        ...
        if (mid < end) {
          right =
            new TreeList.AVLNode<>(iterator, mid + 1, end, mid, this, next);
        } else {
          rightIsNext = true;
          right = next;
        }
      ...
      TreeList.AVLNode<E> get(final int index) {
        ...
        final TreeList.AVLNode<E> nextNode = indexRelativeToMe < 0
          ? getLeftSubTree()
          : getRightSubTree();
        if (nextNode == null) {
          return null;
      ...
      private TreeList.AVLNode<E> insertOnLeft(
        final int indexRelativeToMe,
        final E obj
      ) {
        if (getLeftSubTree() == null) {
      ...
      private TreeList.AVLNode<E> insertOnRight(
        final int indexRelativeToMe,
        final E obj
      ) {
        if (getRightSubTree() == null) {
      ...
      private TreeList.AVLNode<E> removeSelf() {
        ...
        if (getLeftSubTree() == null) {
          right.relativePosition +=
            relativePosition - (relativePosition < 0 ? 0 : 1);
      ...
      private void recalcHeight() {
        height =
          Math.max(
            ...
            getRightSubTree() == null ? -1 : getRightSubTree().height
          ) +
          1;
      }
      ...
      private TreeList.AVLNode<E> rotateLeft() {
        ...
        final TreeList.AVLNode<E> movedNode = getRightSubTree()
          .getLeftSubTree();
      ...
      private TreeList.AVLNode<E> rotateRight() {
        ...
        final TreeList.AVLNode<E> movedNode = getLeftSubTree()
          .getRightSubTree();
      ...
      private void setLeft(
        final TreeList.AVLNode<E> node,
        final TreeList.AVLNode<E> previous
      ) {
      ...
      private TreeList.AVLNode<E> addAll(
        TreeList.AVLNode<E> otherTree,
    ...
    static class TreeListIterator<E>
      ...
      private TreeListIterator(final TreeList<E> parent, final int fromIndex)
