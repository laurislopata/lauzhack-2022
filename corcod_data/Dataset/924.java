...
public class gr1 {
  ...
  static class ascend implements Comparator<pair> {
    ...
    public int compare(pair o1, pair o2) {
      if (o1.b != o2.b) return (int) (o1.b - o2.b); else return (int) (
        o1.a - o2.a
      );
    }
  }
  ...
  static class extra {
    ...
    static boolean valid(int i, int j, int r, int c) {
      if (i >= 0 && i < r && j >= 0 && j < c) return true; else return false;
    }
    ...
    static void seive() {
      for (int i = 2; i < 100001; i++) {
        if (!v[i]) {
          t++;
          l.add(i);
          for (int j = 2 * i; j < 100001; j += i) v[j] = true;
        }
      }
    }
    ...
    static int binary(pair a[], int val, int n) {
      ...
      while (l <= r) {
        ...
        if (a[mid].a == val) {
          r = mid - 1;
          ans = mid;
        } else if (a[mid].a > val) r = mid - 1; else {
          l = mid + 1;
          ans = l;
        }
      }
