...
public class Main {
  ...
  public static class Util {
    ...
    public static <T extends Comparable<T>> void merge_sort(
      T[] a,
      int l,
      int r
    ) {
    ...
    private static <T extends Comparable<T>> void merge_sort0(
      T[] a,
      Object[] temp,
      int l,
      int r
      ...
      int x = l, y = mid, c = l;
      while (x < mid || y < r) {
        if (y == r || (x < mid && a[x].compareTo(a[y]) <= 0)) temp[c++] =
          a[x++]; else temp[c++] = a[y++];
      }
    ...
    public static <T extends Comparable<T>> void quick_sort(
      T[] a,
      int l,
      int r
    ) {
    ...
    private static <T extends Comparable<T>> void quick_sort0(
      T[] a,
      int l,
      int r
    ) {
    ...
    public static void bucket_sort(int[] a, int l, int r) {
      ...
      while (y < Integer.SIZE) {
        ...
        for (int i = r - 1; i >= l; i--) b[--cnt[a[i] >> y &
            (1 << BOUND) - 1]] =
          a[i];
        y += BOUND;
        Arrays.fill(cnt, 0);
