  ...
  public static void main(String[] args) {
    ...
    if (m == 3 || s == 3 || p == 3) {
      if (
        ...
        d4 == 1 &
        d3 == 2
      ) System.out.println(0); else if (d3 == 0 & d4 == 0) System.out.println(
        0
      ); else if (d3 < d5 & d3 < d4) {
        if (d3 == 1 || d3 == 2 || d3 == 0) System.out.println(
          1
        ); else System.out.println(2);
      } else if (d5 < d4 & d5 < d3) {
        if (d5 == 1 || d5 == 2 || d5 == 0) System.out.println(
          1
        ); else System.out.println(2);
      } else if (d4 < d5 & d4 < d3) {
        if (d4 == 1 || d4 == 2 || d4 == 0) System.out.println(
          1
        ); else System.out.println(2);
      } else if (
        d3 == 2 &
    ...
    if (m == 2 || s == 2 || p == 2) {
      ...
      if (c1 == c2) {
        if (n1 == n2) System.out.println(1); else if (
          d3 == 1 || d3 == 2
        ) System.out.println(1); else System.out.println(2);
      }
      if (c1 == c3) {
        if (n1 == n3) System.out.println(1); else if (
          d4 == 1 || d4 == 2
        ) System.out.println(1); else System.out.println(2);
      }
      if (c2 == c3) {
        if (n2 == n3) System.out.println(1); else if (
          d5 == 1 || d5 == 2
        ) System.out.println(1); else System.out.println(2);
      }
    }
